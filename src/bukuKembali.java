 ...
 * @author arija
 */
public class bukuKembali extends javax.swing.JFrame {
String kembali;
String pulang;
    /**
...
private void tampil(){
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 890, 243));

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/Backk.png"))); // NOI18N
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 470, 100, 90));
        ...
        jButton1.setBackground(new java.awt.Color(232, 0, 0));
        ...
        jButton4.setBackground(new java.awt.Color(232, 232, 0));
        ...
        jPanel1.add(txtsrc, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 40, 150, 30));
        ...
        jLabel2.setMaximumSize(new java.awt.Dimension(327, 33));
        jLabel2.setMinimumSize(new java.awt.Dimension(327, 33));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 20, 530, 50));

        jLabel3.setFont(new java.awt.Font("Tw Cen MT", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 153, 0));
        jLabel3.setText("BACK");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 540, 170, 50));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 560, 810, 20));
...
// TODO add your handling code here:
    ...
    try {
        String status = "Sudah Kembali";
            ...
            Connection conn=(Connection)Koneksi.connectDB();
    ...
    try{
        ...
        try{
            ...
            ResultSet data1 = st1.executeQuery(query1);
            ...
            while(data1.next()){
               ...
               try {
                       ...
                       java.sql.PreparedStatement pst=conn2.prepareStatement(sql1);
                       pst.execute();
                   } catch (Exception e) {
                       JOptionPane.showMessageDialog(null, "Perubahan Data Gagal"+e.getMessage());
                   }
